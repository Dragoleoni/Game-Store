...
namespace GameStoreLab.Infrastructure.Contexts;

public partial class GameStoreContext : DbContext
{
    public GameStoreContext(IConfiguration configuration)
    {
        Configuration = configuration;
    }

    public GameStoreContext(DbContextOptions<GameStoreContext> options, IConfiguration configuration)
        : base(options)
    {
        Configuration = configuration;
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(Configuration.GetConnectionString("GameStoreCS"));
